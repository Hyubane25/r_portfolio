...
#Edited
ggplot(data = hotel_bookings) +
 geom_col(mapping = aes(x = stays_in_weekend_nights, y = children))
```
...
#0 children guests have the most weekend nights, which supports the statement of the stakeholder into a TRUE statement.

What other types of plots could you use to show this relationship?
#geom_col for more redability.
